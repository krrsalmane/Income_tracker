    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md border-t-4 border-red-500">
        ...
        <form action="add_expense.php" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="description" id="description" placeholder="e.g., Groceries, Rent..." required
            ...
            <div>
                <label for="category" class="block text-sm font-medium text-gray-700 mb-1">Category (Bonus)</label>
